...
export const PRODUCTOS_BASE = [
  // INICIO ESTRATÉGICO: Bolsos hermosos, versátiles y de precios accesibles (enganche comercial)
  ...
  // GAMA PREMIUM (Salen a partir de la 4ta posición en adelante, nunca al inicio)
  ...
  // COMPLEMENTOS, CANGUROS Y MINI BOLSOS ACCESIBLES
